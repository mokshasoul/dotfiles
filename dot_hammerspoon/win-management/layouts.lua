...
local function dockSwitcher(dockToUse)
  local alfredUri = "alfred://runtrigger/de.chris-grieser.dock-switcher/load-dock-layout/?argument=" .. dockToUse
...
M.caff_unlock = c.new(function(event)
  if (event == c.screensDidUnlock or event == c.systemDidWake) and not env.isAtOffice and not env.isProjector() then
